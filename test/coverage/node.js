...
run('./node_modules/nyc/bin/nyc.js -s --no-clean bin/readytest test/tests/standalone/focused-test.js');
run('./node_modules/nyc/bin/nyc.js -s --no-clean bin/readytest test/tests/standalone/empty.js');
run('./node_modules/nyc/bin/nyc.js -s --no-clean bin/readytest -f top test/tests/suites.js');
run('./node_modules/nyc/bin/nyc.js -s --no-clean bin/readytest -f none test/tests/suites.js');
run('./node_modules/nyc/bin/nyc.js -s --no-clean bin/readytest test/tests/standalone/failure-suite.js');
run('./node_modules/nyc/bin/nyc.js -s --no-clean bin/readytest test/tests/standalone/failure-test.js');
